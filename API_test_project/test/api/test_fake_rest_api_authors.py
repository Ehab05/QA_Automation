...
from API_test_project_part_b.logic.api.entries.author_entity import AuthorEntity
...
class TestFakeRestAPIAuthor(unittest.TestCase):
    ...
    def test_get_all_authors(self):
        ...
        self.assertIsInstance(authors.data, list)
    ...
    def test_get_author_by_id(self):
        ...
        self.assertTrue(author.data["id"] == author_id)
        # Asserting the response body idbook and firstname type
        self.assertIsInstance(author.data["idBook"], int)
        self.assertIsInstance(author.data["firstName"], str)
    ...
    def test_post_valid_author(self):
        ...
        valid_author = AuthorEntity().author_to_dict()
    ...
    def test_update_author_by_id(self):
        ...
        updated_author = AuthorEntity().updated_author_by_id(author_id)
        ...
        self.assertDictEqual(updated_author, response.data)
    ...
    def test_delete_author(self):
        ...
        self.assertFalse(author_id in authors.data)
